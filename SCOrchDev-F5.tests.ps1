...
$manifestPath = "$here\SCOrchDev-F5.psd1"
Import-Module $manifestPath -Force

Describe -Tags 'VersionChecks' 'SCOrchDev-F5 manifest' {
    ...
    It 'has a valid name in the manifest' {
        $script:manifest.Name | Should Be SCOrchDev-F5
    }

    It 'has a valid guid in the manifest' {
        $script:manifest.Guid | Should Be 'd705ab9b-8b88-4642-9cb6-9a152f69f19f'
    }
